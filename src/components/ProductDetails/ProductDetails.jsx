  ...
  return (
    <div className="container mt-5 ">
      <div className="mt-5 row justify-content-between ">
        ...
        <div className="d-flex flex-column gap-2 col-md-8 bgColor p-5 rounded-3">
          <div className="fs-4">{title}</div>
          <div className="fs-5 fcolor">{category.name}</div>
          ...
          <div className="d-flex justify-content-center">
            <div
              className={`my-3 py-1 rounded-3 text-center w-50 text-light btn `}
            >
              Add to cart
            </div>
          </div>
