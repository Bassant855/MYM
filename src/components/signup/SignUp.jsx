...
function SignUp() {
  ...
  const validationSchema = Yup.object({
    ...
    password: Yup.string()
      .matches(
        /^(?=.*[A-Z])(?=.*[!@#$%^&*()_+{}\[\]:;<>,.?~])(?=.*[0-9a-zA-Z]).{8,}$/,
        "Password must be eight characters starting with an uppercase letter, one special character, and alphanumeric characters"
      )
      .required(),
  ...
  return (
    <div className="container w-75 mt-3">
      <div className=" d-flex flex-column justify-content-center align-items-center align-content-center ">
        ...
        >
          <div className="fs-4 fw-bold mb-2 ">Register</div>
