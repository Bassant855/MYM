    ...
    <div className="portfolio my-5 py-3 ">
      <div className="container">
        ...
        <div className="port-btns mt-3 mb-5">
          ...
          <button
            className={category === "design" ? "active" : "port-btn "}
            onClick={buttonHandeler}
          ...
          <button
            className={category === "mobile" ? "active" : "port-btn "}
            onClick={buttonHandeler}
          ...
          <button
            className={category === "other" ? "active" : "port-btn "}
            onClick={buttonHandeler}
            data-category="other"
          >
            ...
            data.slice(0,8).map((d) => {
              return (
                <div key={d.id} className="port">
                  ...
                  <a href={d.link} className="port-hover-btn red-btn">
        ...
        <div style={{ textAlign: "center",marginBottom:"10px"}}>
          <Link className="red-btn  " to="/services" style={{width:"30%",minWidth:"fit-content",display:'block', margin:"auto"}}>
