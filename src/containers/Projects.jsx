...
export const ProjectProvider =  ({ children }) => {
  ...
  //     imgSrc: { img },
  //     links: [
  //       { image: icon3, link: "https://www.behance.com" },
  //       { image: icon4, link: "https://www.github.com" },
  //       { image: ln, link: "https://www.linkedin.com" },
  //     ],
  //     title: {
  ...
  useEffect(() => {
    const getproData =  getProData()
    setDUMMY_DATA(getproData)
